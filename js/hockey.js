...
function details(event) {
    ...
    fetch(url, options)
    .then(resp => resp.json())          //  wait for the response and convert it to JSON
    .then(teams => showGameDetails(teams));
}

function showGameDetails(details) {
...
/*
const url = 'https://hockey-highlights-api.p.rapidapi.com/leagues?limit=100&season=2024&offset=0';
*/