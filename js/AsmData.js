...
{Mnemonic:  'LDURD',    Format:'D',     Width:11,     OpCode:'11111100010',   Shamt:  '',         Start:  '7E2',      End: '',    },
{Mnemonic:  'LDURH',    Format:'D',     Width:11,     OpCode:'01111000010',   Shamt:  '',         Start:  '3C2',      End: '',    },
{Mnemonic:  'LDURS',    Format:'D',     Width:11,     OpCode:'10111100010',   Shamt:  '',         Start:  '5E2',      End: '',    },
...
let instructions = [
{Hex: "0XD10043FF",    Binary: '11010001000000000100001111111111',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XF80003E5",    Binary: '11111000000000000000001111100101',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XF80043E6",    Binary: '11111000000000000100001111100110',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0X8B1F03EA",    Binary: '10001011000111110000001111101010',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XF10008BF",    Binary: '11110001000000000000100010111111',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0X5400006D",    Binary: '01010100000000000000000001101101',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0X910004CA",    Binary: '10010001000000000000010011001010',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0X17FFFFFD",    Binary: '00010111111111111111111111111101',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XF84043E5",    Binary: '11111000010000000100001111100101',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XF84003E6",    Binary: '11111000010000000000001111100110',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0X910043FF",    Binary: '10010001000000000100001111111111',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XD61F03C0",    Binary: '11010110000111110000001111000000',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XD00000A1",    Binary: '11010000000000000000000010100001',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0X9104C021",    Binary: '10010001000001001100000000100001',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XF8400025",    Binary: '11111000010000000000000000100101',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XF8408026",    Binary: '11111000010000001000000000100110',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0X9B087CA8",    Binary: '10011011000010000111110010101000',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0X97FFFFEF",    Binary: '10010111111111111111111111101111',    Instruction: 'ADDI      sp,        sp,      0x10      '},
{Hex: "0XD503201F",    Binary: '11010101000000110010000000011111',    Instruction: 'ADDI      sp,        sp,      0x10      '},
// {Hex: '0x1400000E',    Binary: '00010100000000000000000000001110',      Instruction: 'B         56                            '},
// {Hex: '0x14000996',    Binary: '00010100000000000000100110010110',      Instruction: 'B         2560                          '},
// {Hex: '0x17FFFFD4',    Binary: '00010111111111111111111111010100',      Instruction: 'B         -176                          '},
// {Hex: '0x17FFFFD5',    Binary: '00010111111111111111111111010101',      Instruction: 'B         -172                          '},
// {Hex: '0x17FFFFEE',    Binary: '00010111111111111111111111101110',      Instruction: 'B         -72                           '},
...
// {Hex: '0x17FFFFFC',    Binary: '00010111111111111111111111111100',      Instruction: 'B         16                            '},
...
// {Hex: '0x5400006C',    Binary: '01010100000000000000000001101100',      Instruction: 'B.GT      12                            '},
// {Hex: '0x5400006C',    Binary: '01010100000000000000000001101100',      Instruction: 'B.GT      12                            '},
...
// {Hex: '0x540000A0',    Binary: '01010100000000000000000010100000',      Instruction: 'B.EQ      20                            '},
...
// {Hex: '0x540002EA',    Binary: '01010100000000000000001011101010',      Instruction: 'B.GE      92                            '},
// {Hex: '0x54FFFF68',    Binary: '01010100111111111111111101101000',      Instruction: 'B.HI      -20                           '},
// {Hex: '0x54FFFFA0',    Binary: '01010100111111111111111110100000',      Instruction: 'B.EQ      -0xc                          '},
// {Hex: '0x54FFFFA1',    Binary: '01010100111111111111111110100001',      Instruction: 'B.NE      -12                           '},
...
// {Hex: '0x9400000C',    Binary: '10010100000000000000000000001100',      Instruction: 'BL        48                            '},
// {Hex: '0x9400000E',    Binary: '10010100000000000000000000001110',      Instruction: 'BL        dilation                      '},
// {Hex: '0x94000017',    Binary: '10010100000000000000000000010111',      Instruction: 'BL        92                            '},
...
// {Hex: '0x97FFFFD1',    Binary: '10010111111111111111111111010001',      Instruction: 'BL        4096                          '},
// {Hex: '0x97FFFFDE',    Binary: '10010111111111111111111111011110',      Instruction: 'BL        -0x32                         '},
// {Hex: '0x97FFFFE0',    Binary: '10010111111111111111111111100000',      Instruction: 'BL        -128                          '},
// {Hex: '0x97FFFFEA',    Binary: '10010111111111111111111111101010',      Instruction: 'BL        -0x22                         '},
// {Hex: '0x97FFFFEA',    Binary: '10010111111111111111111111101010',      Instruction: 'BL        -88                           '},
// {Hex: '0x97FFFFF0',    Binary: '10010111111111111111111111110000',      Instruction: 'BL        -96                           '},
